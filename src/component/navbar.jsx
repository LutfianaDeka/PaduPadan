...
export default function Navbar() {
  ...
  <div className="relative flex justify-between items-center h-20 px-6">
    {/* Logo + Teks */}
    <div
    ...
    <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 gap-6 text-green-700 font-medium text-sm">
      <button
        onClick={() => navigate("/home")}
        className={`pb-1 ${
          isActive("/home")
