  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-4 pt-24">
        ...
        <div className="fixed top-0 left-0 w-full h-20 bg-white border-b border-gray-200 z-40 flex items-center px-4">
          <button onClick={() => navigate(-1)} className="text-[#2E8B57] absolute left-4">
            <ArrowLeft size={24} />
          </button>
          <h1 className="text-xl font-semibold text-[#2E8B57] w-full text-center">Profil</h1>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="relative group">
              ...
              <label
                ...
                className={`absolute bottom-0 right-0 bg-green-600 text-white p-2 rounded-full cursor-pointer hover:bg-green-700 transition-colors ${uploading ? 'opacity-50 cursor-not-allowed' : ''}`}
        ...
        <div>
          ...
          {styles.length === 0 ? (
            <div className="text-center py-12 bg-gray-50 rounded-lg">
              <p className="text-gray-500">You haven't uploaded any styles yet.</p>
              <button
